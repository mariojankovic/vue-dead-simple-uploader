<template>
  <div class="vue-dsu">
    <div class="vue-dsu__wrapper">
      <div class="vue-dsu__input-wrapper">
        <template v-if="imageURL.length > 0">
          <button @click="removeImage()"
          class="vue-dsu__input-remove" :class="{ 'is-persistent': preview === false }">
          ...
          <p v-if="preview === false" class="vue-dsu__file-name">{{ imageURL }}</p>

          <div v-if="preview" class="vue-dsu__input-preview" :style="{ backgroundImage: `url(${imageURL})` }"></div>
        </template>
